...
// Add 'ref' as the second argument here
const Footer = forwardRef(({ onAboutClick }, ref) => {
  return (
    // Now this 'ref' is correctly defined and can be attached
    <div ref={ref} className='footer text-[#d9d9d9] bg-[#323232] py-5 px-[8vw] pt-20 mt-[5vw]'>
